  ...
  return (
    <>
      ...
      {!isExpanded ? (
        ...
        <Portal>
          <div ref={modalRef} className="fixed z-[9999] p-4 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[441px] bg-card-bg/50 border border-gray-800 rounded-xl shadow-lg max-h-[93.5vh] overflow-y-auto pb-6 transition-all duration-500 ease-in-out opacity-100 scale-100" data-widget="find-developer">
            <button
